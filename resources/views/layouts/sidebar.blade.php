            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a wire:navigate class="nav-link"
                            href="{{ route('admin.market.category.index') }}">Category</a></li>
                    <li class="nav-item"> <a wire:navigate class="nav-link"
                            href="{{ route('admin.market.brand.index') }}">Brands</a></li>
                    <li class="nav-item"> <a wire:navigate class="nav-link"
                            href="{{ route('admin.market.product.index') }}">Products</a></li>
